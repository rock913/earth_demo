"""TDD tests for V5 report generation endpoint.

V5 roadmap:
- Feed zonal statistics JSON into LLM to generate a monitoring brief.

For now we require a deterministic template fallback so demo works without LLM.
"""
